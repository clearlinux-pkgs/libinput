...
Source0  : https://gitlab.freedesktop.org/libinput/libinput/-/archive/1.26.0/libinput-1.26.0.tar.gz
...
%prep
%setup -q -n libinput-1.26.0
cd %{_builddir}/libinput-1.26.0
pushd ..
cp -a libinput-1.26.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717692576

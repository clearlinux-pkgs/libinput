...
Source0  : https://gitlab.freedesktop.org/libinput/libinput/-/archive/1.27.1/libinput-1.27.1.tar.gz
...
%prep
%setup -q -n libinput-1.27.1
cd %{_builddir}/libinput-1.27.1
pushd ..
cp -a libinput-1.27.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736175170

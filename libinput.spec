...
Source0  : https://gitlab.freedesktop.org/libinput/libinput/-/archive/1.26.2/libinput-1.26.2.tar.gz
...
%prep
%setup -q -n libinput-1.26.2
cd %{_builddir}/libinput-1.26.2
pushd ..
cp -a libinput-1.26.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724032006

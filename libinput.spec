...
Source0  : https://gitlab.freedesktop.org/libinput/libinput/-/archive/1.28.0/libinput-1.28.0.tar.gz
...
%prep
%setup -q -n libinput-1.28.0
cd %{_builddir}/libinput-1.28.0
pushd ..
cp -a libinput-1.28.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742824632
